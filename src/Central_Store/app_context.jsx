...
export const AppProvider = ({ children }) => {
  ...
  // override it manually. For anything else (plain objects/strings meant
  // to be sent as JSON) we set Content-Type: application/json ourselves,
  // otherwise the server sees "text/plain" and rejects it with 415.
  const buildBodyAndHeaders = (payload) => {
