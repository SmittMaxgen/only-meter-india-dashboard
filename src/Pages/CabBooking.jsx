...
//           {/* Left */}
//           <div>
//             <h1 className="text-xl font-semibold text-gray-900">Cab Booking</h1>
//             <div className="text-sm text-gray-500">
//               Dashboard <span className="text-orange-500">/ Cab Booking</span>
//             </div>
//           </div>
...
export default function CabBooking() {
  ...
  useEffect(() => {
    ...
    const carRides = (fetchedData?.rides || []).filter(
      (ride) => ride.vehicle_type !== "Auto",
    );
    setRides(carRides);
  }, [fetchedData?.rides]);
