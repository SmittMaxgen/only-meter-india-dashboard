...
function Modal({
  ...
  // const [name, setName] = useState(nameOptions);
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                {/* Important: Show current name even if it's not in nameOptions */}
                {!nameOptions.includes(name) && name && (
...
export default function VehicleFare() {
  ...
  console.log("fetchedData.types", fetchedData.types);
  console.log("NAME_OPTIONS", NAME_OPTIONS);
